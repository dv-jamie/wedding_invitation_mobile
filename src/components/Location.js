...
import parkingInfo from '../assets/images/parking_info.jpg';
        ...
        <ul>
          ...
          <li className={styles.list}>
            ...
            <ul>
              ...
              <div className={styles.image_wrap}>
                <img src={parkingInfo} alt="주차장 이미지" />
              </div>
                퍼시픽타워 지하주차장 (B3 ~ B6층)<br />
                <span>*</span> 로비에서 <span>셀프 주차등록</span> 가능 → 3시간 무료<br />
                <span>*</span> 주차장 입구가 좁으니 주의하세요!
              </li>
            </ul>
          </li>
        </ul>
